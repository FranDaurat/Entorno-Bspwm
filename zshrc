...
export PATH=/opt/kitty/bin:$HOME/.local/bin:/opt/my_scripts:$HOME/go/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/sbin/:/opt/nvim/nvim-linux64/bin
